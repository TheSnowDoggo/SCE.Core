namespace SCECore.Types
{
    ...
    public class DisplayMap : Grid2D<Pixel>
    {
        ...
        public DisplayMap(Vector2Int dimensions, byte bgColor)
            : base(dimensions)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayMap"/> class given a base <see cref="DisplayMap"/>.
        /// </summary>
        /// <param name="displayMap">The base <see cref="DisplayMap"/> containing the <see cref="Pixel"/>  <see cref="Grid2D{T}"/> to set the new instance to.</param>
        public DisplayMap(DisplayMap displayMap)
            : base(displayMap)
        {
        }
        ...
        /// </summary>
        /// <param name="elementGrid">The grid containing every <see cref="Pixel.Element"/> of the overal <see cref="Pixel"/> <see cref="Grid2D{T}"/>.</param>
        /// <param name="fgGrid">The grid containing every <see cref="Pixel.FgColor"/> of the overal <see cref="Pixel"/> <see cref="Grid2D{T}"/>.</param>
        /// <param name="bgGrid">The grid containing every <see cref="Pixel.BgColor"/> of the overal <see cref="Pixel"/> <see cref="Grid2D{T}"/>.</param>
        public DisplayMap(Grid2D<string> elementGrid, Grid2D<byte> fgGrid, Grid2D<byte> bgGrid)
        ...
        public delegate void CustomMapLine(Vector2Int position, string line, byte fgColor = Color.White, byte bgColor = Color.Transparent);
        ...
        /// <param name="fgGrid">The <see cref="byte"/> <see cref="Grid2D{T}"/> containing the <see cref="Pixel.FgColor"/> of every <see cref="Pixel"/>.</param>
        /// <param name="bgGrid">The <see cref="byte"/> <see cref="Grid2D{T}"/> containing the <see cref="Pixel.BgColor"/> of every <see cref="Pixel"/>.</param>
        ...
        /// <inheritdoc/>
        public override DisplayMap Clone() => new(base.Clone());
        ...
        public void MapLine(Vector2Int position, string line, byte fgColor = Color.White, byte bgColor = Color.Transparent)
        {
            ...
            for (int x = 0; x < pixelLength; x++)
            {
                ...
                this[mappedPos] = new(build, Color.GetStackColor(fgColor, oldPixel.FgColor), Color.GetStackColor(bgColor, oldPixel.BgColor));
            }
        }
        ...
        /// <param name="ignoreOverflow">Whether overflow errors should be silently dealt with.</param>
        public void FgColorFillArea(byte fgColor, Area2DInt area, bool ignoreOverflow = false)
        {
            void CycleAction(Vector2Int pos)
            {
                Pixel oldPixel = this[pos];
        ...
        /// </summary>
        /// <param name="fgColor">The foreground <see cref="byte"/> color to fill with.</param>
        public void FgColorFill(byte fgColor)
        {
        ...
        public void BgColorFillArea(byte bgColor, Area2DInt area, bool ignoreOverflow = false)
        {
            void CycleAction(Vector2Int pos)
            {
                Pixel oldPixel = this[pos];
        ...
        /// </summary>
        /// <param name="bgColor">The background <see cref="byte"/> color to fill with.</param>
        public void BgColorFill(byte bgColor)
        {
        ...
        public void BgColorFillHorizontalArea(byte bgColor, int y, Vector2Int range)
        {
        ...
        public void BgColorFillVerticalArea(byte bgColor, int x, Vector2Int range)
        {
        ...
        /// <param name="bgColor">The background <see cref="byte"/> color to fill with.</param>
        /// <param name="y">The constant y-coordinate of the line.</param>
        public void BgColorFillHorizontal(byte bgColor, int y)
        {
        ...
        /// <param name="bgColor">The background <see cref="byte"/> color to fill with.</param>
        /// <param name="x">The constant x-coordinate of the line.</param>
        public void BgColorFillVertical(byte bgColor, int x)
        {
        ...
        public override void MapToArea(Grid2D<Pixel> dataGrid, Area2DInt dataGridArea, Vector2Int? positionOffset = null, bool tryTrimOnResize = false)
        {
            ...
            void CycleAction(Vector2Int position)
            {
                ...
                if (!tryTrimOnResize || PositionValid(mappedPos))
                {
                    ...
                    this[mappedPos] = new(pixel.Element, Color.GetStackColor(pixel.FgColor, oldPixel.FgColor), Color.GetStackColor(pixel.BgColor, oldPixel.BgColor));
                }
            }
        ...
        public override void MapAreaFrom(Grid2D<Pixel> dataGrid, Area2DInt thisArea, Vector2Int? positionOffset = null, bool tryTrimOnResize = false)
        {
            ...
            void CycleAction(Vector2Int pos)
            {
                ...
                if (!tryTrimOnResize || dataGrid.PositionValid(mappedPos))
                {
                    ...
                    this[pos] = new(pixel.Element, Color.GetStackColor(pixel.FgColor, oldPixel.FgColor), Color.GetStackColor(pixel.BgColor, oldPixel.BgColor));
                }
            }
