namespace SCECore.Types
{
        ...
        where T : IConvertible
    {
        ...
        private string[] SplitValueList(string listStr)
        {
            ...
            {
                return SCEString.SplitExcludingBounds(listStr, SplitChar, LeftBoundArray);
            }
            return SCEString.SplitExcludingBounds(listStr, SplitChar, LeftBoundArray, RightBoundArray);
        }
