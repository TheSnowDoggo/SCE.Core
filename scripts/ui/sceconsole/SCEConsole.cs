namespace SCE
{
    ...
    public class SCEConsole : UIBase
    {
        ...
        private const SCEColor DEFAULT_FGCOLOR = SCEColor.White;
        ...
        public SCEConsole(string name, Vector2Int dimensions, SCEColor? bgColor = null)
            : base(name)
        {
        ...
        /// <param name="dimensions">The dimensions of the console.</param>
        /// <param name="isActive">The initial active state of the console.</param>
        public SCEConsole(Vector2Int dimensions, SCEColor? bgColor = null)
        ...
        private string AdjustedHeader { get => StringUtils.PostFitToLength(SmartHeader, ui.Width); }
        ...
        private string BuildLogList()
        {
            ...
            if (i < logList.Count)
            {
                do
                {
                    ...
                    {
                        strBuilder.Append(StringUtils.PostFitToLength(line, ui.Width));
                    }
