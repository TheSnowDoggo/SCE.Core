namespace SCE
{
    ...
    {
        public Rect2DInt(int left, int bottom, int right, int top)
        {
        ...
        public Rect2DInt(int right, int top)
            : this(0, 0, right, top)
        {
        }
        ...
        public static Rect2DInt operator +(Rect2DInt a1, Rect2DInt a2) => new(a1.Left + a2.Left, a1.Bottom + a2.Bottom, a1.Right + a2.Right, a1.Top + a2.Top);

        public static Rect2DInt operator +(Rect2DInt a1, Vector2Int v) => new(a1.Left + v.X, a1.Bottom + v.Y, a1.Right + v.X, a1.Top + v.Y);
        ...
        public static Rect2DInt operator -(Rect2DInt a) => new(-a.Left, -a.Bottom, -a.Right, -a.Top);
        ...
        public static Rect2DInt Vertical(int x, int bottom, int top)
        {
        ...
        public static Rect2DInt GetOverlap(int l1, int b1, int r1, int t1, int l2, int b2, int r2, int t2)
        {
